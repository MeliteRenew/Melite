...
private slots:
    ...
    void on_BuyMelite_clicked();
    void on_SellMeliteBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputMelite_textChanged(const QString &arg1);
    ...
    QString BuyMelite(QString OrderType, double Quantity, double Rate);
    QString SellMelite(QString OrderType, double Quantity, double Rate);
