...
unsigned int nTargetSpacing = 1 * 30; // Melite - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // Melite - time to elapse before new modifier is computed
...
const string strMessageMagic = "Melite Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    // proof of stake rewards. POS begins at block 10
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Melite", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.com/news/world-39048293";
        CTransaction txNew;
        txNew.nTime = 1487760559;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1487760559;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 13943856;
        ...
        assert(block.hashMerkleRoot == uint256("0x6c557bedb09c80488699f05bb3c9b7def6081666ae65d8ad52ef512174131ab6"));
    ...
    string strPubKey = "";
