...
!define URL http://www.Melite.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Melite.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Melite-qt.exe
...
OutFile Melite-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Melite-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Melited.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Melite.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Melite-qt.exe
